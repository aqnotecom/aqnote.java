...
import com.madding.shared.components.task.AbstractTask;
import com.madding.shared.components.test.task.sub.MemberService;
...
public class AbstractTaskTest extends AbstractTask {
    ...
    class AutoProduceRunnable extends TimerTask { // implements Runnable {
    ...
    public static void main(String args[]) {
        ...
        AbstractTaskTest task = new AbstractTaskTest();
        task.init(args);
        task.execute(1000);
    }
}
