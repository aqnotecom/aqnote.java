...
/**
 * @author "Peng Li"<aqnote@aqnote.com> May 16, 2012 9:31:22 AM
 */
@BTrace
public class OfferDangerousDetailsTracer {
    
    public final static String className = "com.alibaba.bops.biz.offer.util.OfferDangerousFieldsUtil"; 
    public final static String classMethod = "setOfferDangerousDetails";
