 ...
 */
package com.madding.shared.net.socket.ssl;

import static com.madding.shared.net.socket.ssl.command.SSLCommand.BYE;
import static com.madding.shared.net.socket.ssl.command.SSLCommand.DATE;
import static com.madding.shared.net.socket.ssl.command.SSLCommand.HELLO;
import static com.madding.shared.net.socket.ssl.command.SSLCommand.HELP;
import static com.madding.shared.net.socket.ssl.command.SSLCommand.command;
...
import com.madding.shared.net.socket.ssl.command.SSLCommand;
