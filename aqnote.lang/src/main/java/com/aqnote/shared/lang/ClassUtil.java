 ...
 * </p>
 * 
 * @author "Peng Li"<aqnote@aqnote.com> May 7, 2012 5:30:29 PM
 */
public class ClassUtil {
     ...
     * @return the requested Class object, if clazz not exit return null;
     */
    public static Class<?> getClass(String clazz) {
        ...
        if (loader != null) {
            try {
                ...
                // If not found with ThreadContext loader,
                // fall thru to try System classloader below
