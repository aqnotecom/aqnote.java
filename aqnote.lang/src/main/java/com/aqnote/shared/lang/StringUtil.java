...
/**
 * 类StringUtil.java的实现描述： 有关字符串处理的工具类。
 * <p>
 * 这个类中的每个方法都可以“安全”地处理<code>null</code>，而不会抛出<code>NullPointerException</code>。
 * </p>
 * 
 * @author "Peng Li"<aqnote@aqnote.com> May 7, 2012 5:26:08 PM
 */
public class StringUtil {
    ...
    /**
     * 从字符串尾部开始查找指定字符串集合中的字符串，并返回第一个匹配的起始索引。 如果字符串为<code>null</code>，则返回<code>-1</code>。 如果字符串集合为<code>null</code>或空，也返回
     * <code>-1</code>。 如果字符串集合包括<code>""</code>，并且字符串不为<code>null</code>，则返回<code>str.length()</code>
     * 
     * <pre>
