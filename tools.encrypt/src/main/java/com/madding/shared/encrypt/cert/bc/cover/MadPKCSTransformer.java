...
public class MadPKCSTransformer implements MadBCConstant {
    ...
    public static String getCrtFileString(Certificate cert) throws Exception {
        ...
        pemWriter.flush();
        pemWriter.close();
        String crtFile = StreamUtil.stream2Bytes(cbb.getInputStream(), Charset.UTF_8);
    ...
    public static String getCRLFileString(X509CRL x509CRL) throws Exception {
        ...
        pemWriter.flush();
        pemWriter.close();
        String crlFile = StreamUtil.stream2Bytes(cbb.getInputStream(), Charset.UTF_8);
        cbb.getInputStream().close();
        cbb.clear();
        return crlFile;
    }
    ...
    public static String getKeyFileString(PrivateKey privKey) throws Exception {
        ...
        pemWriter.flush();
        pemWriter.close();
        String keyFile = StreamUtil.stream2Bytes(cbb.getInputStream(), Charset.UTF_8);
        cbb.getInputStream().close();
        cbb.clear();
        return keyFile;
    }
