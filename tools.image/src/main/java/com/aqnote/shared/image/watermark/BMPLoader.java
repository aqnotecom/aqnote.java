 ...
 */
package com.aqnote.shared.image.watermark;
...
public class BMPLoader {
    ...
    /**
     * load method - see read for details Arguments: sdir and sfile are the result of the FileDialog() getDirectory()
     * and getFile() methods. Returns: Image Object, be sure to check for (Image)null !!!!
     */
    ...
    /**
     * load method - see read for details Arguments: sdir - full path name Returns: Image Object, be sure to check for
     * (Image)null !!!!
     */
