...
package com.madding.shared.javacc.math.adder;
...
public class Adder implements AdderConstants {
  ...
  final public int _start() throws ParseException {
  int value;
  int result;
    result = _primary();
    label_1:
  ...
  final public int _primary() throws ParseException, NumberFormatException {
  Token tmpToken;
    tmpToken = jj_consume_token(NUMBER);
    {if (true) return Integer.parseInt(tmpToken.image);}
    throw new Error("Missing return statement in function");
  }
