...
public class eg4TokenManager implements eg4Constants {
        ...
        for (;;) {
            ...
            if (curChar < 64) {
                ...
                do {
                    switch (jjstateSet[--i]) {
                        case 10:
                            if (curChar == 42) jjCheckNAddTwoStates(16, 17);
                        ...
                        case 13:
                            ...
                            break;
                        case 14:
                            if (curChar == 13) jjstateSet[jjnewStateCnt++] = 13;
                            break;
                        case 15:
                            if (curChar == 42) jjCheckNAddTwoStates(16, 17);
                            break;
                        case 16:
                            if ((0xfffffbffffffffffL & l) != 0L) jjCheckNAddTwoStates(16, 17);
                            break;
                        case 17:
                            if (curChar == 42) jjAddStates(8, 9);
                            break;
                        case 18:
                            if ((0xffff7fffffffffffL & l) != 0L) jjCheckNAddTwoStates(19, 17);
                            break;
                        case 19:
                            if ((0xfffffbffffffffffL & l) != 0L) jjCheckNAddTwoStates(19, 17);
                            break;
                        case 20:
                ...
                do {
                    switch (jjstateSet[--i]) {
                        ...
                        case 4:
                            ...
                            break;
                        case 2:
                            if ((0x100000001000L & l) != 0L && kind > 7) kind = 7;
                            break;
                        case 6:
                            if ((0x100000001000000L & l) != 0L) jjCheckNAdd(7);
                            break;
                        case 7:
                ...
                do {
                    switch (jjstateSet[--i]) {
                        case 11:
                            ...
                            break;
                        case 16:
                            if ((jjbitVec0[i2] & l2) != 0L) jjCheckNAddTwoStates(16, 17);
                            break;
                        case 18:
                        case 19:
                            if ((jjbitVec0[i2] & l2) != 0L) jjCheckNAddTwoStates(19, 17);
                            break;
                        default:
                            break;
                    }
    ...
    public static final String[]      jjstrLiteralImages = { "", null, null, null, null, null, null, null, null, null,
            null, null, null, null, "\73", "\53", "\55", "\52", "\57", "\45", "\50", "\51", };

    /** Lexer state names. */
    public static final String[]      lexStateNames      = { "DEFAULT", };
    static final long[]               jjtoToken          = { 0x3fc881L, };
