...
public abstract class nsVerifier {
    ...
    public static final byte eStart = (byte)0;
    public static final byte eError = (byte)1;
    public static final byte eItsMe = (byte)2;
    public static final int eidxSft4bits = 3;
    public static final int eSftMsk4bits = 7;
    public static final int eBitSft4bits = 2;
    public static final int eUnitMsk4bits = 0x0000000F;
