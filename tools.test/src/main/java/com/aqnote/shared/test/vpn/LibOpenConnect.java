/*
 * OpenConnect (SSL + DTLS) VPN client Copyright © 2013 Kevin Cernekee <cernekee@gmail.com> This program is free
 * software; you can redistribute it and/or modify it under the terms of the GNU Lesser General Public License version
 * 2.1, as published by the Free Software Foundation. This program is distributed in the hope that it will be useful,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.
 * See the GNU Lesser General Public License for more details.
 */

package com.aqnote.shared.test.vpn;
...
public abstract class LibOpenConnect {
    ...
    public synchronized native void setMobileInfo(String mobilePlatformVersion, String mobileDeviceType,
    ...
    public static class IPInfo {
        ...
        void addDNS(String arg) {
            DNS.add(arg);
        }

        void addNBNS(String arg) {
            NBNS.add(arg);
        }

        void addSplitDNS(String arg) {
            splitDNS.add(arg);
        }

        void addSplitInclude(String arg) {
            splitIncludes.add(arg);
        }

        void addSplitExclude(String arg) {
            splitExcludes.add(arg);
        }

        void addCSTPOption(String key, String value) {
            CSTPOptions.put(key, value);
        }

        void addDTLSOption(String key, String value) {
            DTLSOptions.put(key, value);
        }
    }
